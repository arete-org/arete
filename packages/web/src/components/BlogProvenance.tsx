    ...
    return (
        ...
        >
            ...
            <div className="provenance-main">
                <div className="blog-provenance__author">
                    <img
                        ...
                        loading="lazy"
                    />
                    <span className="blog-provenance__author-name">
                        {post.author.login}
                    </span>
                </div>
                ...
                <time
                    className="blog-provenance__date"
                ...
                {isUpdated && (
                    <>
                        <span className="provenance-separator"> • </span>
                        <time
                            className="blog-provenance__updated"
            ...
            <div className="provenance-meta">
                <span className="blog-provenance__discussion-id">
                    Discussion #{post.number}
                </span>
                <span className="provenance-separator"> • </span>
                <span className="blog-provenance__created-full">
                    {createdDate}
                </span>
                {isUpdated && (
                    <>
                        <span className="provenance-separator"> • </span>
                        <span className="blog-provenance__updated-full">
                            Updated: {updatedDate}
                        </span>
                    </>
                )}
