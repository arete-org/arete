...
const markdownComponents: Components = {
    ...
    h1: ({ children, ...props }: MarkdownProps<'h1'>) => (
        <h1 className="blog-markdown__h1" {...props}>
            {children}
        </h1>
    ),
    h2: ({ children, ...props }: MarkdownProps<'h2'>) => (
        <h2 className="blog-markdown__h2" {...props}>
            {children}
        </h2>
    ),
    h3: ({ children, ...props }: MarkdownProps<'h3'>) => (
        <h3 className="blog-markdown__h3" {...props}>
            {children}
        </h3>
    ),
    h4: ({ children, ...props }: MarkdownProps<'h4'>) => (
        <h4 className="blog-markdown__h4" {...props}>
            {children}
        </h4>
    ),
    h5: ({ children, ...props }: MarkdownProps<'h5'>) => (
        <h5 className="blog-markdown__h5" {...props}>
            {children}
        </h5>
    ),
    h6: ({ children, ...props }: MarkdownProps<'h6'>) => (
        <h6 className="blog-markdown__h6" {...props}>
            {children}
        </h6>
    ),
    ...
    p: ({ children, ...props }: MarkdownProps<'p'>) => (
        <p className="blog-markdown__p" {...props}>
            {children}
        </p>
    ),

    // Links
    a: ({ href, children, ...props }: MarkdownProps<'a'>) => (
        <a
            href={href}
    ...
    // Code blocks
    code: ({ children, className, ...props }: MarkdownProps<'code'>) => {
        const isInline = !className;
        if (isInline) {
            return (
                <code className="blog-markdown__code-inline" {...props}>
                    {children}
                </code>
            );
        }
        return (
            <code className="blog-markdown__code-block" {...props}>
                {children}
            </code>
        );
    },
    ...
    blockquote: ({ children, ...props }: MarkdownProps<'blockquote'>) => (
        <blockquote className="blog-markdown__blockquote" {...props}>
            {children}
        </blockquote>
    ),
    ...
    ul: ({ children, ...props }: MarkdownProps<'ul'>) => (
        <ul className="blog-markdown__ul" {...props}>
            {children}
        </ul>
    ),
    ol: ({ children, ...props }: MarkdownProps<'ol'>) => (
        <ol className="blog-markdown__ol" {...props}>
            {children}
        </ol>
    ),
    li: ({ children, ...props }: MarkdownProps<'li'>) => (
        <li className="blog-markdown__li" {...props}>
            {children}
        </li>
    ),
    ...
    table: ({ children, ...props }: MarkdownProps<'table'>) => (
        <div className="blog-markdown__table-wrapper">
            <table className="blog-markdown__table" {...props}>
                {children}
            </table>
        </div>
    ),
    thead: ({ children, ...props }: MarkdownProps<'thead'>) => (
        <thead className="blog-markdown__thead" {...props}>
            {children}
        </thead>
    ),
    tbody: ({ children, ...props }: MarkdownProps<'tbody'>) => (
        <tbody className="blog-markdown__tbody" {...props}>
            {children}
        </tbody>
    ),
    tr: ({ children, ...props }: MarkdownProps<'tr'>) => (
        <tr className="blog-markdown__tr" {...props}>
            {children}
        </tr>
    ),
    th: ({ children, ...props }: MarkdownProps<'th'>) => (
        <th className="blog-markdown__th" {...props}>
            {children}
        </th>
    ),
    td: ({ children, ...props }: MarkdownProps<'td'>) => (
        <td className="blog-markdown__td" {...props}>
            {children}
        </td>
    ),
        ...
        return (
            <section className="site-section">
                ...
                <article className="card">
                    ...
                    <p>
                        We couldn&apos;t find a blog post with discussion number{' '}
                        <code>{number}</code>.
                    </p>
