    ...
    const handleBlogIndexRequest = async (
        ...
        try {
            ...
            logRequest(
                req,
                res,
                `blog index error ${error instanceof Error ? error.message : 'unknown error'}`
            );
        }
    };
    ...
    const handleBlogPostRequest = async (
        ...
        try {
            ...
            logRequest(
                req,
                res,
                `blog post error ${error instanceof Error ? error.message : 'unknown error'}`
            );
        }
    };
