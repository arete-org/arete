...
const HALF_SCALE_ICON_TRANSFORM_MATRIX = 'matrix(0.5 0 0 0.5';
const FINGERPRINT_ICON_TRANSFORM = `${HALF_SCALE_ICON_TRANSFORM_MATRIX} 48 48)`;
const CLOCK_ICON_TRANSFORM = `${HALF_SCALE_ICON_TRANSFORM_MATRIX} 6 6)`;
