/**
 * @description: Trusted internal `/image` task endpoint methods for Discord bot backend integration.
 * @footnote-scope: utility
 * @footnote-module: DiscordInternalImageApi
 * @footnote-risk: medium - Transport mistakes can break the backend-owned image task.
