...
Together they form an infrastructure for **ethical model autonomy**, enabling Footnote to move away from closed APIs while preserving auditability, provenance, and performance.

---

## Motivation

Footnote's ethical framework emphasizes **transparency, auditability, and independence from opaque model providers**. Current reliance on proprietary APIs (e.g., OpenAI) creates friction with this philosophy.  
...
- Integrate with **MCP servers** to connect Footnote's tools, datasets, and ethics-core.
...
This architecture allows Footnote to:
...
- **Footnote lens compatibility:** Expose each reasoning lens (e.g., Core, Jedi, Stonerism) as a fine-tuned model variant within the Toolkit.
...
- Footnote ethics core: https://github.com/arete-org/ethics-core

---

_Prepared for internal review and community discussion within the Footnote organization._
